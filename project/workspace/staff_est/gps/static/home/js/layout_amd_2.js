...
require([
    ...
    var defaultUrlGeoServer = "http://staff.estchile.cl:8080";//local
...
/****TODO MAPA*****/
    ...
    */
    ...
    function styleArea(feature) { //asigna el estilo con el color de relleno de acuerdo a su nivel de riesgo
        return {
            weight: 2,
            opacity: 1,
            color: 'white',
    ...
    function stylePlanta(feature) { //asigna el estilo con el color de relleno de acuerdo a su nivel de riesgo
        return {
            weight: 2,
            opacity: 1,
            color: 'white',
...
*/
        ...
        var leyenda= "<div id='wrapperCard'><img id='logoEstCard' src='https://personal.hfgroup.cl/logo4.png' ><img id='imgQRCard' src='/static/images/estchile.png' ><div id='datosTrabajadorCard'><b>Nombre : </b>"+f.properties["nombre"]+"</br><b>Cargo : </b>"+f.properties["cargo"]+"</br><b>Fono : </b>"+f.properties["fono"]+"</br><b>Riesgo : </b>"+f.properties["nivel_riesgo"]+"</br><b>Fono Emergencia : </b>"+f.properties["super_fono"]+"</br><b>Supervisor : </b>"+f.properties["supervisor"]+"</br><b>Zona : </b>"+tempZona+"</br><b>Actualizado : </b>"+f.properties["fixtime"]+"</br></div><img id='imgTrabajadorCard' src='https://lh3.googleusercontent.com/proxy/cTb8QcosKi_c3GSiFkLzpjo9r8aNYlhsxdXxWyBDGzNhyuNOrfiaxOVhOm8GWa36qw-sO8WffUVPhXB62l87BJPoYqHn6-OUuGWV0l_9_SgE'></div>";
        l.bindPopup(leyenda);
...
*/
    ...
    var urlGeoserverZona= defaultUrlGeoServer+"/geoserver/cite/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=cite:est_zona&maxFeatures=50&outputFormat=application%2Fjson";
    var urlGeoserverPlanta= defaultUrlGeoServer+"/geoserver/cite/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=cite:est_planta&maxFeatures=50&outputFormat=application%2Fjson";
    var urlGeoserverAreas= defaultUrlGeoServer+"/geoserver/cite/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=cite:area&maxFeatures=50&outputFormat=application%2Fjson";
    //var urlEdificios= "/static/edificios.json";


    var jsonTest = new L.GeoJSON.AJAX([urlGeoserverZona/*,"counties.geojson"*/],{style: style, onEachFeature:popUpEdificios});
    var jsonTest2 = new L.GeoJSON.AJAX([urlGeoserverPlanta/*,"counties.geojson"*/],{style: stylePlanta, onEachFeature:popUpPlanta});
    var jsonTest3 = new L.GeoJSON.AJAX([urlGeoserverAreas/*,"counties.geojson"*/],{style: styleArea, onEachFeature:popUpArea});
